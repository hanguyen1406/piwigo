...
$lang['last %d days'] = 'τις τελευταίες %d ημέρες';
$lang['Last'] = 'Τελευταία';
...
$lang['Pre-established filters are proposed, but you can add or remove them using the "Choose filters" button.'] = 'Προτείνονται προκαθορισμένα φίλτρα, αλλά μπορείτε να τα προσθέσετε ή να τα αφαιρέσετε χρησιμοποιώντας το κουμπί "Επιλογή φίλτρων".';
...
$lang['last 24 hours'] = 'τις τελευταίες 24 ώρες';
$lang['last 3 months'] = 'Τελευταίοι 3 μήνες';
$lang['last 30 days'] = 'Τελευταίες 30 ημέρες';
$lang['last 6 months'] = 'Τελευταίοι 6 μήνες';
$lang['last 7 days'] = 'Τελευταίες 7 μέρες';
$lang['last year'] = 'Πέρυσι';
$lang['rating score %s'] = 'βαθμολογία %s';
$lang['year %d'] = 'έτος %d';
$lang['%d visits'] = '%d επισκέψεις';
...
$lang['Clear'] = 'Καθαρά';
$lang['Empty filters'] = 'Άδεια φίλτρα';
$lang['File type'] = 'Τύπος αρχείου';
