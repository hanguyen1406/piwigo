...
$lang['Validate'] = 'Validera';
$lang['You can try to edit your filters and perform a new search.'] = 'Du kan försöka ändra dina filter och göra en ny sökning.';
$lang['last 24 hours'] = 'senaste 24 timmarna';
$lang['last 3 months'] = 'Senaste 3 månaderna';
$lang['last 30 days'] = 'Senaste 30 dagarna';
$lang['last 6 months'] = 'Senaste 6 månaderna';
$lang['last 7 days'] = 'Senaste 7 dagarna';
$lang['last year'] = 'Förra året';
$lang['rating score %s'] = 'betygspoäng %s';
$lang['year %d'] = 'år %d';
$lang['%d visits'] = '%d besök';
$lang['Added by'] = 'Tillagd av';
$lang['Album description'] = 'Albumbeskrivning';
$lang['Album title'] = 'Albumtitel';
$lang['Albums found'] = 'Album hittade';
$lang['Albums listed here match your search by word. Click on one to browse by album.'] = 'Album som listas här matchar din sökning efter ord. Klicka på en för att bläddra efter album.';
$lang['Cancel'] = 'Avbryt';
$lang['Choose filters'] = 'Välj filter';
$lang['Clear'] = 'Rensa';
$lang['Empty filters'] = 'Tomma filter';
$lang['File type'] = 'Filtyp';
$lang['Fill in the filters to start a search'] = 'Fyll i filter för att börja söka';
$lang['Filters'] = 'Filter';
$lang['No results are available.'] = 'Inga resultat är tillgängliga.';
$lang['Pre-established filters are proposed, but you can add or remove them using the "Choose filters" button.'] = 'Förinställda filter föreslås, men du kan lägga till eller ta bort dem med knappen "Välj filter".';
$lang['Search in :'] = 'Sök i :';
