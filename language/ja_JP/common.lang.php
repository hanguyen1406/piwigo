...
$lang['Confirm Password'] = 'パスワードを再度入力';
...
$lang['display most visited photos'] = '最もアクセスされた写真を表示する';
$lang['Unknown identifier'] = '不明なID';
$lang['New password'] = '新しいパスワード';
$lang['Rate this photo'] = 'この写真を評する';
$lang['Next'] = '次へ';
$lang['no rate'] = '評価なし';
$lang['Photos posted within the last %d day.'] = '最近 %d 日間に投稿された写真のみ表示します。';
...
$lang['display recently updated albums'] = '最近更新されたアルバムを表示する';
$lang['Recent period'] = '最近の期間';
$lang['Recent photos'] = '最近の写真';
$lang['display most recent photos'] = '最近の写真を表示する';
...
$lang['display only recently posted photos'] = '最近投稿された写真のみ表示する';
...
$lang['photos posted during the last %d days'] = '最近 %d 日間に投稿された写真';
...
$lang['Reset to default values'] = 'デフォルトに戻す';
...
$lang['Welcome'] = 'ようこそ';
$lang['Welcome to your Piwigo photo gallery!'] = 'Piwigoフォト・ギャラリーにようこそ!';
$lang['... or browse your empty gallery'] = '... または、空のギャラリーを閲覧する';
$lang['... or please deactivate this message, I will find my way by myself'] = '... または、このメッセージを無効にして下さい。自分で解決してみます。';
$lang['Hello %s, your Piwigo photo gallery is empty!'] = 'こんにちは %sさん, あなたのPiwigoフォト・ギャラリーには何も入っていません!';
...
$lang['%d rates'] = '%d 程度';
$lang['Rating score'] = '評価点';
$lang['Invalid username or email'] = '無効なユーザー名又はメールアドレス';
$lang['Password reset is not allowed for this user'] = 'このユーザーのパスワードはリセットできません。';
...
$lang['Username "%s" on gallery %s'] = 'ユーザー： "%s" は現在： %s\'のギャラリー';
$lang['To reset your password, visit the following address:'] = 'パスワードをリセットするためには、このアドレスへ：';
$lang['If this was a mistake, just ignore this email and nothing will happen.'] = 'もしこれが手違いの場合、このメールを無視して下さい。そうすれば何も起こりません。';
...
$lang['The passwords do not match'] = 'パスワードが一致しません';
$lang['Your password has been reset'] = 'あなたのパスワードはリセットされました。';
$lang['Return to home page'] = 'ホームページに戻る';
...
$lang['Successfully registered, you will soon receive an email with your connection settings. Welcome!'] = 'ようこそ！登録完了。まもなくあなたの接続設定がメールで届く予定です。';
...
$lang['Piwigo encountered a non recoverable error'] = 'Piwigoに回復不能エラーが発生しました';
$lang['Requested album does not exist'] = '要求されたアルバムは存在しません。';
$lang['Requested tag does not exist'] = '要求されたタグは存在しません。';
$lang['Email address is mandatory'] = '電子メールアドレスを必須にする';
$lang['Username is mandatory'] = 'ユーザー名を必須にする';
$lang['Website'] = 'ウェブサイト';
