...
$lang['%d comment to validate'] = '%d 則評論等待驗證';
$lang['%d comments to validate'] = '%d 則評論等待驗證';
$lang['%d new comment'] = '%d 則新評論';
$lang['%d new comments'] = '%d 則新評論';
$lang['%d comment'] = '%d 則評論';
$lang['%d comments'] = '%d 則評論';
$lang['%d hit'] = '查看 %d 次';
$lang['%d hits'] = '查看 %d 次';
$lang['%d new photo'] = '%d 張新圖片';
$lang['%d new photos'] = '%d 張新圖片';
$lang['%d new user'] = '%d 位新用戶';
$lang['%d new users'] = '%d 位新用戶';
$lang['About'] = '關於';
$lang['All tags'] = '所有標籤';
$lang['Any tag'] = '任何標籤';
$lang['Author'] = '擁有者';
...
$lang['Thumbnails'] = '縮略圖';
$lang['Menu'] = '選單';
$lang['A comment on your site'] = '在您網站上的評論';
$lang['today'] = '今天';
$lang['Update your rating'] = '更改投票';
$lang['the username must be given'] = '缺少用戶名';
$lang['useful when password forgotten'] = '在忘記密碼時會有幫助';
...
$lang['Album: %s'] = '相冊: %s';
$lang['Bad status for user "guest", using default status. Please notify the webmaster.'] = '使用者 "訪客" 狀態異常，將使用預設狀態。請通知管理員。';
...
$lang['%d photo'] = '%d 張圖片';
$lang['%d photos'] = '%d 張圖片';
$lang['%d photo is also linked to current tags'] = '%d 張圖片同時與目前標籤相關';
$lang['%d photos are also linked to current tags'] = '%d 張圖片同時與目前標籤相關';
$lang['display photos linked to this tag'] = '只查看和這標籤相關的圖片';
$lang['photos posted during the last %d days'] = '最近 %d 天上傳的照片';
...
$lang['%d photos per page'] = '每頁 %d 張相片';
$lang['Theme'] = '主題';
...
$lang['Link: %s'] = '連結: %s';
$lang['Password: ********** (no copy by email)'] = '密碼：**********（不要直接從郵件中複製）';
$lang['Invalid username or password!'] = '使用者名稱不存在或密碼不符！';
$lang['Related albums'] = '相關的相簿';
$lang['Your authentication key is no longer valid.'] = '您的認證金鑰已失效。';
$lang['generate random password'] = '產生隨機密碼';
$lang['Start-Date'] = '開始日期';
$lang['Album name, 100 &rarr; 10 &rarr; 5 &rarr; 1'] = '相冊名稱, 100 &rarr; 10 &rarr; 5 &rarr; 1';
$lang['Album name, 1 &rarr; 5 &rarr; 10 &rarr; 100'] = '相冊名稱, 1 &rarr; 5 &rarr; 10 &rarr; 100';
$lang['Validate'] = '生效';
$lang['You can try to edit your filters and perform a new search.'] = '您可以編輯自己的過濾條件以進行搜尋。';
$lang['last 24 hours'] = '過去 24 小時';
$lang['last 3 months'] = '過去 3 個月';
$lang['last 30 days'] = '過去 30 天';
$lang['last 6 months'] = '過去 6 個月';
$lang['last 7 days'] = '過去 7 天';
$lang['last year'] = '去年';
$lang['rating score %s'] = '評分為 %s';
$lang['year %d'] = '%d 年';
$lang['%d visits'] = '被訪問過 %d 次';
$lang['Added by'] = '加入者為';
$lang['Album description'] = '相簿描述';
$lang['Album title'] = '相簿名稱';
$lang['Albums found'] = '找到的相簿';
$lang['Albums listed here match your search by word. Click on one to browse by album.'] = '此處列出所有符合關鍵字的相簿。點選相簿即可瀏覽內容。';
$lang['Cancel'] = '取消';
$lang['Choose filters'] = '選擇過濾條件';
$lang['Clear'] = '清除';
$lang['Empty filters'] = '清除過濾條件';
$lang['File type'] = '檔案類型';
$lang['Fill in the filters to start a search'] = '開始搜尋前請填入過濾條件';
$lang['Filters'] = '過濾條件';
$lang['No results are available.'] = '沒有符合條件的結果。';
$lang['Pre-established filters are proposed, but you can add or remove them using the "Choose filters" button.'] = '建議使用預先建立的過濾條件，但您也可以使用「選擇過濾條件」按鈕新增或移除過濾條件。';
$lang['Search in :'] = '在此範圍中搜尋：';
