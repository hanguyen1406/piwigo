    ...
    var Youtube = videojs.extend(Tech, {
        ...
        initYTPlayer: function () {
            ...
            if (this.options_.source.src.indexOf("start=") !== -1) {
                var srcStartTime =
                    this.options_.source.src.match(/start=([0-9]*)/);
            ...
            var playerConfig = {
                ...
                events: {
                    ...
                    onPlaybackRateChange:
                        this.onPlayerPlaybackRateChange.bind(this),
            ...
            if (
                typeof this.options_.enablePrivacyEnhancedMode !==
                    "undefined" &&
        ...
        ended: function () {
            return this.ytPlayer
                ? this.lastState === YT.PlayerState.ENDED
                : false;
        },
        volume: function () {
