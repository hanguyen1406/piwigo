        ...
        var w = function (e) {
                if (n.controls()) {
                    ...
                    if (
                        (d ||
                            t == o ||
                            t == o.querySelector(".vjs-tech") ||
                            t == o.querySelector(".iframeblocker") ||
                            t == o.querySelector(".vjs-control-bar")) &&
                        m
                    ) {
                        e = window.event || e;
                        var r = Math.max(
                        ...
                        e.preventDefault(),
                            1 == r
                                ? n.volume(n.volume() + c)
                                : -1 == r && n.volume(n.volume() - c);
                    }
                }
            },
            k = function (e, r) {
                return t.playPauseKey(e, r)
                    ? 1
                    : t.rewindKey(e, r)
                    ? 2
                    : t.forwardKey(e, r)
            ...
            n.on("keydown", function (e) {
                ...
                if (n.controls()) {
                    ...
                    if (
                        d ||
                        h == o ||
                        h == o.querySelector(".vjs-tech") ||
                        h == o.querySelector(".vjs-control-bar") ||
                        h == o.querySelector(".iframeblocker")
                    )
                        switch (k(e, n)) {
                            case 1:
                                m(),
                            ...
                            default:
                                if (
                                    ...
                                    a > 95 && (w = 96);
                                    var K = a - w;
                                    m(), n.currentTime(n.duration() * K * 0.1);
                                }
