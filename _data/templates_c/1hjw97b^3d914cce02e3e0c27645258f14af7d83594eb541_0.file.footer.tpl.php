...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_66d5c1545ea080_95735534',
...
function content_66d5c1545ea080_95735534 (Smarty_Internal_Template $_smarty_tpl) {
?>        <!-- Start of footer.tpl -->
...
$_block_repeat=true;
echo $_block_plugin13->block_footer_script(array('require'=>'bootstrap'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
 $('body').bootstrapMaterialDesign();
<?php $_block_repeat=false;
echo $_block_plugin13->block_footer_script(array('require'=>'bootstrap'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
